<?php
    ...
    if(isset($_POST['btn_upload'])) 
    {
        ...
        $filepath = "../images/monitor/".$filename;
        ...
        $sql="INSERT INTO `monitor`(`monitor_id`, `image_name`, `image_path`, `image_type`, `monitor_n_price`, `monitor_o_price`, `monitor_title`, `monitor_info`) 
...
<form id="product" name="product" enctype="multipart/form-data" method="post" action="_monitor_data_inputer.php">
    <p>Monitor ID</p>
