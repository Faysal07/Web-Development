<?php
    ...
    if(isset($_POST['btn_upload'])) 
    {
        ...
        $filepath = "../images/headphone/".$filename;
        ...
        $sql="INSERT INTO `headphone`(`headphone_id`, `image_name`, `image_path`, `image_type`, `headphone_n_price`, `headphone_o_price`, `headphone_title`, `headphone_info`) 
...
<form id="product" name="product" enctype="multipart/form-data" method="post" action="_headphone_data_inputer.php">
    <p>Headphone ID</p>
