<?php
    ...
    if(isset($_POST['btn_upload'])) 
    {
        ...
        $filepath = "../images/mouse/".$filename;
        ...
        $sql="INSERT INTO `mouse`(`mouse_id`, `image_name`, `image_path`, `image_type`, `mouse_n_price`, `mouse_o_price`, `mouse_title`, `mouse_info`) 
...
<form id="product" name="product" enctype="multipart/form-data" method="post" action="_mouse_data_inputer.php">
    <p>Mouse ID</p>
