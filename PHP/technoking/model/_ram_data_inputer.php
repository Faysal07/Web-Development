<?php
    ...
    if(isset($_POST['btn_upload'])) 
    {
        ...
        $sql="INSERT INTO `ram`(`ram_id`, `image_name`, `image_path`, `image_type`, `ram_n_price`, `ram_o_price`, `ram_title`, `ram_info`) 
...
<form id="product" name="product" enctype="multipart/form-data" method="post" action="demo_inputer.php">
    <p>Ram ID</p>
