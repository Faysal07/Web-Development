<?php
    ...
    if(isset($_POST['btn_upload'])) 
    {
        ...
        $filepath = "../images/power_sulpply/".$filename;
        ...
        $sql="INSERT INTO `power_supply`(`power_id`, `image_name`, `image_path`, `image_type`, `power_n_price`, `power_o_price`, `power_title`, `power_info`) 
...
<form id="product" name="product" enctype="multipart/form-data" method="post" action="_power_data_inputer.php">
    <p>Ram ID</p>
