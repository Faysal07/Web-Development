                        ...
                        <div class="products-item">
                            ...
                            <div class="product-content">
                                <div class="product-price">
                                    <span class="new-price">৳ <?php echo $rows['watch_n_price']; ?></span>
                                    <span class="old-price">৳ <?php echo $rows['watch_o_price']; ?></span>
                                </div>
                                <h5 class="product-name"><?php echo $rows['watch_title']; ?></h5>
                            </div>
                        </div>
                    </div>
