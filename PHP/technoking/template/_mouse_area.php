...
<section class="watch-items" id="monitors">
        <div class="container">
            ...
            <div class="owl-carousel" id="mouse-carousel">
                        ...
                        <div class="products-item">
                            ...
                            <div class="product-content">
                                <div class="product-price">
                                    <span class="new-price">৳ <?php echo $rows['mouse_n_price']; ?></span>
                                    <span class="old-price">৳ <?php echo $rows['mouse_o_price']; ?></span>
                                </div>
                                <h5 class="product-name"><?php echo $rows['mouse_title']; ?></h5>
                            </div>
                        </div>
                    </div>
